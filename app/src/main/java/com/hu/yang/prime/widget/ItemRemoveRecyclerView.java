        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mDeleteBtnState == 0) {
                    ...
                    ItemDelFragment.MyAdapter.MyViewHolder viewHolder= (ItemDelFragment.MyAdapter.MyViewHolder) getChildViewHolder(view);
                    mItemLayout = viewHolder.itemView;
//                    mPosition = viewHolder.getAdapterPosition();
                    mDelete = (TextView) mItemLayout.findViewById(R.id.im_post_delete);
